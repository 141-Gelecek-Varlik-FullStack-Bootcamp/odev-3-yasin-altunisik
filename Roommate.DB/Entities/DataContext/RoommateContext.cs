...
namespace Roommate.DB.Entities.DataContext
{
    public partial class RoommateContext : DbContext
    {
        public RoommateContext()
        {
        }

        public RoommateContext(DbContextOptions<RoommateContext> options)
            : base(options)
        {
        }
